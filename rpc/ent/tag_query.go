...
func (_q *TagQuery) QueryDramas() *DramaQuery {
...
func (_q *TagQuery) QueryDramaTags() *DramaTagQuery {
...
func (_q *TagQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *TagQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *TagQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *TagQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *TagQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *TagQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *TagQuery) WithDramas(opts ...func(*DramaQuery)) *TagQuery {
	query := (&DramaClient{config: _q.config}).Query()
...
func (_q *TagQuery) WithDramaTags(opts ...func(*DramaTagQuery)) *TagQuery {
	query := (&DramaTagClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TagQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Tag, error) {
	...
	if query := _q.withDramas; query != nil {
		if err := _q.loadDramas(ctx, query, nodes,
			func(n *Tag) { n.Edges.Dramas = []*Drama{} },
			func(n *Tag, e *Drama) { n.Edges.Dramas = append(n.Edges.Dramas, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withDramaTags; query != nil {
		if err := _q.loadDramaTags(ctx, query, nodes,
			func(n *Tag) { n.Edges.DramaTags = []*DramaTag{} },
			func(n *Tag, e *DramaTag) { n.Edges.DramaTags = append(n.Edges.DramaTags, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *TagQuery) loadDramas(ctx context.Context, query *DramaQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *Drama)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[uint64]*Tag)
	nids := make(map[uint64]map[*Tag]struct{})
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(tag.DramasTable)
		s.Join(joinT).On(s.C(drama.FieldID), joinT.C(tag.DramasPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(tag.DramasPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(tag.DramasPrimaryKey[1]))
...
func (_q *TagQuery) loadDramaTags(ctx context.Context, query *DramaTagQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *DramaTag)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uint64]*Tag)
	for i := range nodes {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(dramatag.FieldTagID)
	}
	query.Where(predicate.DramaTag(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(tag.DramaTagsColumn), fks...))
	}))
