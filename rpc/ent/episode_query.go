...
func (_q *EpisodeQuery) QueryDrama() *DramaQuery {
...
func (_q *EpisodeQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *EpisodeQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *EpisodeQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *EpisodeQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *EpisodeQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *EpisodeQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *EpisodeQuery) WithDrama(opts ...func(*DramaQuery)) *EpisodeQuery {
	query := (&DramaClient{config: _q.config}).Query()
...
func (_q *EpisodeQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Episode, error) {
	...
	if query := _q.withDrama; query != nil {
		if err := _q.loadDrama(ctx, query, nodes, nil,
			func(n *Episode, e *Drama) { n.Edges.Drama = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *EpisodeQuery) loadDrama(ctx context.Context, query *DramaQuery, nodes []*Episode, init func(*Episode), assign func(*Episode, *Drama)) error {
	ids := make([]uint64, 0, len(nodes))
	nodeids := make(map[uint64][]*Episode)
	for i := range nodes {
		fk := nodes[i].DramaID
...
func (_q *EpisodeQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(episode.Table, episode.Columns, sqlgraph.NewFieldSpec(episode.FieldID, field.TypeUint64))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withDrama != nil {
			_spec.Node.AddColumnOnce(episode.FieldDramaID)
		}
	}
