...
func (_c *TagCreate) SetLanguage(v string) *TagCreate {
	_c.mutation.SetLanguage(v)
	return _c
}

// SetNillableLanguage sets the "language" field if the given value is not nil.
func (_c *TagCreate) SetNillableLanguage(v *string) *TagCreate {
	if v != nil {
		_c.SetLanguage(*v)
	}
	return _c
...
func (_c *TagCreate) SetID(v uint64) *TagCreate {
	_c.mutation.SetID(v)
	return _c
}

// AddDramaIDs adds the "dramas" edge to the Drama entity by IDs.
func (_c *TagCreate) AddDramaIDs(ids ...uint64) *TagCreate {
	_c.mutation.AddDramaIDs(ids...)
	return _c
}

// AddDramas adds the "dramas" edges to the Drama entity.
func (_c *TagCreate) AddDramas(v ...*Drama) *TagCreate {
...
func (_c *TagCreate) check() error {
	...
	if _, ok := _c.mutation.Language(); !ok {
		return &ValidationError{Name: "language", err: errors.New(`ent: missing required field "Tag.language"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
